...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "Take no Prisoners")
WEBUI_FAVICON_URL = "https://itishstudios.net/assert/botg.jpg"
...
if CUSTOM_NAME:
    ...
    if WEBUI_NAME != "Take no Prisoners":
        WEBUI_NAME += " (Take no Prisoners)"
